...
const validations = {
  ...
  minValue: (input) => isNotNullOrUndefined(input) && isNumber(parseInt(input)) && matchMinMax(parseInt(input), -32768, 32768),
  maxValue: (input) => isNotNullOrUndefined(input) && isNumber(parseInt(input)) && matchMinMax(parseInt(input), -32768, 32768),
